...
asta ahora, hemos desarrollado modelos para interacciones bidireccionales entre dos predictores sólo en el caso especial de que al menos una de las dos variables sea discreta -
incluyendo la binaria como un caso especial de discreta. Ahora introducimos una clase especial
de interacciones continuas por continuas.
...
Es un estimador insesgado, sin embargo es posible escoger el $\lambda$ para disminuir el sesgo de los estimadores.
*Observación.* Si $\lambda\rightarrow 0$ se tendrá un estimador insesgado $\E(\hat{\betan}_k)\rightarrow \betan$
